...
HD_PWD='C:/Users/REV/VivadoProjects/DWT/DWT.runs/blk_mem_gen_32x256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_32x256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_32x256.tcl
