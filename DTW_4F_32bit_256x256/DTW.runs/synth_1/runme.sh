...
HD_PWD='C:/Users/REV/VivadoProjects/DWT_4F_32bit_256x256_Signature_Dataset/DWT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dtw_4F_32bit_256x256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dtw_4F_32bit_256x256.tcl
