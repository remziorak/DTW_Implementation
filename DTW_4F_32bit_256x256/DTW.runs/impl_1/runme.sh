...
HD_PWD='C:/Users/REV/VivadoProjects/DWT_4F_32bit_256x256_Signature_Dataset/DWT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dtw_4F_32bit_256x256.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dtw_4F_32bit_256x256.tcl -notrace
