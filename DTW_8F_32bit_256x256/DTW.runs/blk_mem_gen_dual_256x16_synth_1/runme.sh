...
HD_PWD='C:/Users/REV/VivadoProjects/DWT_4F_32bit_256x256/DWT.runs/blk_mem_gen_dual_256x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_dual_256x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_dual_256x16.tcl
